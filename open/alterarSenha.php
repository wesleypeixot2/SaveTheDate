                ...
                <div class="card mb-3" >
                    ...
                    <div class="row no-gutters">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><a href="./dashboard.php" style="color: black; text-decoration: none;">Meus Orçamentos</a></li>
                            <li class="list-group-item"><a href="#" style="color: black; text-decoration: none;">Meu Perfil</a></li>
                            <li class="list-group-item"><a href="#" style="color: purple; text-decoration: none;">Alterar Senha</a></li>
                        </ul>
                        </div>
                        <div class="col-md-10 myForm myAccount">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" id="senha1" class="form-control" onkeyup="validaSenhaForca();" placeholder="Senha">
                                <div id="impSenha"></div>
                                <div id="password_forte" style="font-size: 10px; color: green; "></div>
                                <div id="password_fraca" style="font-size: 10px; color: red;"></div>
                            </div>
                            <div class="col-md-6">
                                <label></label>
                        ...
                        <div class="row">
                            <div class="col-12 text-center p-3">
                                <button type="button" class="btn btn-primary" style="background-color: purple;" onclick="salvarNovaSenha();">
                                    Atualizar Senha
                                </button>
                            </div>
                        </div>
